...
{: .table }
| ![Attack Pattern]({{ site.baseurl }}/img/icons/attack_pattern.svg){: .relationshipIcon data-tag="Attack_Pattern"} | ![Campaign]({{ site.baseurl }}/img/icons/campaign.svg){: .relationshipIcon data-tag="Campaign"} | ![Course of Action]({{ site.baseurl }}/img/icons/course_of_action.svg){: .relationshipIcon data-tag="Course_of_Action"} |
| ![Grouping]({{ site.baseurl }}/img/icons/grouping.svg){: .relationshipIcon data-tag="Grouping"} | ![Identity]({{ site.baseurl }}/img/icons/identity.svg){: .relationshipIcon data-tag="Identify"} | ![Indicator]({{ site.baseurl }}/img/icons/indicator.svg){: .relationshipIcon data-tag="Indicator"} |
| ![Infrastructure]({{ site.baseurl }}/img/icons/infrastructure.svg){: .relationshipIcon data-tag="Infrastructure"} | ![Intrusion Set]({{ site.baseurl }}/img/icons/intrusion_set.svg){: .relationshipIcon data-tag="Intrusion_Set"} | ![Location]({{ site.baseurl }}/img/icons/location.svg){: .relationshipIcon data-tag="Location"} |
| ![Malware]({{ site.baseurl }}/img/icons/malware.svg){: .relationshipIcon data-tag="Malware"} | ![Malware Analysis]({{ site.baseurl }}/img/icons/malware_analysis.svg){: .relationshipIcon data-tag="Malware_Analysis"} | ![Note]({{ site.baseurl }}/img/icons/note.svg){: .relationshipIcon data-tag="Note"} |
| ![Observed Data]({{ site.baseurl }}/img/icons/observed_data.svg){: .relationshipIcon data-tag="Observed_Data"} | ![Opinion]({{ site.baseurl }}/img/icons/opinion.svg){: .relationshipIcon data-tag="Opinion"} | ![Report]({{ site.baseurl }}/img/icons/report.svg){: .relationshipIcon data-tag="Report"} |
| ![Threat Actor]({{ site.baseurl }}/img/icons/threat_actor.svg){: .relationshipIcon data-tag="Threat_Actor"} | ![Tool]({{ site.baseurl }}/img/icons/tool.svg){: .relationshipIcon data-tag="Tool"} | ![Vulnerability]({{ site.baseurl }}/img/icons/vulnerability.svg){: .relationshipIcon data-tag="Vulnerability"} |
