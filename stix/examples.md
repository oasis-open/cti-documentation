...
| --------------------------------------- | ------------------------------------------------- | ------------------------------------------- |
| [Sighting of Observed-data](/cti-documentation/examples/Sighting-of-observed-data) | ![Identity Icon]({{ site.baseurl }}/img/icons/identity.png) ![Observed-data Icon]({{ site.baseurl }}/img/icons/observed_data.png) ![Sighting Icon]({{ site.baseurl }}/img/icons/sighting.png) ![Malware Icon]({{ site.baseurl }}/img/icons/malware.png) | Observed data represent machine-generated raw information and is different from Indicators which dictate more of an intelligence assertion. These Observed-data SDO's can still be shared and referenced within a Sighting SRO. This example demonstrates the usage of Observed-data and their relation to other STIX objects.
| --------------------------------------- | ------------------------------------------------- | ------------------------------------------- |
